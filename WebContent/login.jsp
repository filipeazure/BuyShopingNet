			...
			<div class="row">
						...
						<h2>
							...
							<form action="PessoaServlet" method="post">
								<input type="text" name="login" placeholder="login" required="required" /> <input
									type="password" name="senha" placeholder="Senha" required="required"/> <input
									type="hidden" name="acao" value="autenticar"> <span>
				...
				<div class="col-sm-4">
					<div class="signup-form">
						...
						<form action="PessoaServlet" method="post">
						<h2><span><%
								Object mensagem2 = request.getAttribute("mensagem2");
								if (mensagem2 != null) {
									out.println(mensagem2);
								}
							%></span></h2>
							<input type="text" name="Login" placeholder="Login"  required="required"/> <input
								type="text" name="Nome" placeholder="Nome" required="required"/> <input
								type="email" name="Email" placeholder="Endereço de Email" required="required"/> <input
								type="email" name="ConfirmaEmail" placeholder="Confirmar Email" required="required"/>
							<input type="password" name="Senha" placeholder="Senha" required="required"/> <input
								type="password" name="ConfirmaSenha"
								placeholder="Confirma Senha" /> <input type="text" name="Cpf"
								placeholder="Seu Cpf" required="required"/> <input type="text" name="ConfirmaCpf"
								placeholder="Confirmar Cpf" required="required" /> <input type="hidden" name="acao"
								value="inserir">
