				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="signup-form">
						...
						<form action="ProdutoServlet" method="post">
							<fieldset><legend><h1>Cadastrar Produto</h1><br></legend>
							<h4>Codigo: </h4><% %><input type="text" name="CodProduto"	placeholder="Codigo do produto" required="required" />
							<h4>Data: </h4><input	type="date" name="DataProduto" placeholder="Data do produto" required="required" /> 
							 <h4>Nome: </h4><input type="text" name="NomeProduto" placeholder="Nome do produto" required="required" />
							<h4> Medida:</h4> <input	type="text" name="Medida" placeholder="Unidade de medida" required="required" /> 
							<h4> Categoria: </h4><input type="text" name="Tipo" placeholder="Tipo/categoria do produto" required="required" />
							<h4> Quantidade:</h4><input type="number" name="Quantidade" placeholder="Quantidade do produto" required="required" /> 
							<h4>Valor: </h4> <input	type="number" name="ValorInicial" placeholder="Valor inicial do produto" required="required" step="0.5" /> 
